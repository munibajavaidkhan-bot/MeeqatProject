...
<body class="min-h-screen font-sans antialiased bg-background text-body">
    ...
    <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: true }">
        ...
        {{-- ══════════ SIDEBAR ══════════ --}}
        <aside
            class="flex-shrink-0 flex flex-col border-r border-dark-800/70 bg-sidebar
        ...
        >
            ...
            {{-- ── Navigation Items ───────────────────────── --}}
            <nav class="flex-1 overflow-y-auto no-scrollbar py-4 px-2 space-y-0.5" aria-label="Main navigation">
                @php
                    $navItems = [
                        [
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            {{-- ── Top Bar ────────────────────────────────── --}}
            <header class="glass-dark border-b border-dark-800/50 px-6 py-4
                ...
                <div>
                    ...
                    @hasSection('page_subtitle')
                        <p class="text-dark-500 text-caption mt-1">@yield('page_subtitle')</p>
                    @endif
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('home') }}"
                       ...
                       class="flex items-center gap-2 px-3 py-2 rounded-btn
                              ...
                              text-dark-400 hover:text-white text-caption
                              transition-all duration-200 hover:bg-dark-700/60
