...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-hero-glow">
    ...
    <div class="absolute inset-0">
        <img src="{{ asset('images/BackgoundMain.png') }}"
             alt=""
    ...
    <div class="container-app relative">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @php
                $features = [
                    [
                        'image'    => asset('images/Chaddar Size Calculator.png'),
                    ...
                    [
                        'image'    => asset('images/Meeqat Location.png'),
                    ...
                    [
                        'image'    => asset('images/Dua Library.png'),
                    ...
                    [
                        'image'    => asset('images/Ihram Guide.png'),
                    ...
                    [
                        'image'    => asset('images/Features Illustration.png'),
                    ...
                    [
                        ...
                        'desc'     => 'Hajj checklist, Qibla direction, prayer times, and many more features in development.',
                        'border'   => 'border-dark-200',
                        'badge'    => 'Coming Soon',
                        'badgecls' => 'badge-gray',
                        'icon'     => '<path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-3 0h3"/>',
                        'route'    => 'home',
                        'cta'      => 'Stay Tuned',
                    ],
                ];
            ...
            <div class="relative grid grid-cols-1 lg:grid-cols-2 gap-8 p-8 md:p-12 items-center">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mt-8 pt-8 border-t border-dark-700/50">
                        <div>
                            <p class="font-heading font-black text-h2 text-white">5+</p>
                ...
                <div class="relative">
                    ...
                    <img src="{{ asset('images/Product Showcase.png') }}"
                         alt="Meeqat.io App Showcase"
                         class="relative rounded-card shadow-elevated w-full"
                         loading="lazy">
                </div>
            </div>
        </div>
...
<section class="py-20">
    <div class="container-app">
        <div class="relative rounded-card overflow-hidden">
            ...
            {{-- Background Image --}}
            <img src="{{ asset('images/Pilgrim Journey.png') }}"
                 alt=""
            ...
            <div class="relative px-8 md:px-16 py-16 flex flex-col md:flex-row items-center justify-between gap-8">
                <div>
                    <h2 class="font-heading font-black text-h1 text-white mb-3 leading-tight">
                        Ready for Your<br>
                        <span class="text-secondary-400">Sacred Journey?</span>
                    </h2>
