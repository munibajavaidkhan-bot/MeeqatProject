...
<div class="pt-32 pb-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-12">
        <div class="flex items-center justify-center gap-4 mb-4">
            ...
            <h1 class="text-4xl font-black text-heading">Niyat <span class="text-primary-600">(Intentions)</span></h1>
        </div>
        <p class="text-muted text-center">Find correct intentions for your rituals</p>
    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    @foreach($group as $niyat)
                        <div class="card p-6">
                            ...
                            <p class="arabic text-2xl text-secondary-600 text-right mb-4">{{ $niyat->arabic_text }}</p>
