...
Route::prefix('calculator')->name('calculator.')->group(function () {
    ...
    Route::post('/chaddar', [\App\Http\Controllers\ChadarCalculatorController::class, 'calculate'])->name('chaddar.calculate');
...
Route::prefix('meeqat')->name('meeqat.')->group(function () {
    ...
    Route::post('/calculate',      [\App\Http\Controllers\MeeqatController::class, 'calculate'])->name('calculate');
    ...
    Route::post('/ajax-calculate', [\App\Http\Controllers\MeeqatController::class, 'ajaxCalculate'])->name('ajax.calculate');
});
...
// ========================================
Route::prefix('virtual-tryon')->name('tryon.')->group(function () {
    Route::get('/', [\App\Http\Controllers\TryOnController::class, 'index'])->name('index');
    Route::post('/process', [\App\Http\Controllers\TryOnController::class, 'process'])->name('process');
});
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Save Try-On Result
    Route::post('/tryon/save', [\App\Http\Controllers\TryOnController::class, 'save'])->name('tryon.save');
});
